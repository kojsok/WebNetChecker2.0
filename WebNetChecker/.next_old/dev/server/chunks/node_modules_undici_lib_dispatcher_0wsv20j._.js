...
const { kBusy, kClients, kConnected, kRunning, kPending, kClose, kDestroy, kDispatch, kUrl } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
...
const Pool = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/pool.js [app-route] (ecmascript)");
const { kOriginless, kUrl } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const kFactory = Symbol('factory');
const kOptions = Symbol('options');
...
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { RequestContentLengthMismatchError, RequestAbortedError, SocketError, InformationalError, InvalidArgumentError, HeadersTimeoutError, BodyTimeoutError, ResponseExceededMaxSizeError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const { kUrl, kReset, kClient, kRunning, kPending, kQueue, kPendingIdx, kRunningIdx, kError, kSocket, kStrictContentLength, kOnError, kMaxConcurrentStreams, kHTTP2Session, kHostAuthority, kResume, kSize, kHTTPContext, kClosed, kKeepAliveDefaultTimeout, kHeadersTimeout, kBodyTimeout, kEnableConnectProtocol, kRemoteSettings, kHTTP2Stream, kHTTP2SessionState, kHTTP2Options, kMaxResponseSize } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const { channels } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/diagnostics.js [app-route] (ecmascript)");
...
function completeRequestStream() {
    ...
    if (state.pendingEnd && !state.request.aborted && !state.request.completed) {
        ...
        // hear back.
        util.errorRequest(state.client, state.request, new InformationalError('HTTP/2: stream closed before the response was complete'));
    }
...
function buildRequestHeaders(reqHeaders) {
    ...
    for(let n = 0; n < reqHeaders.length; n += 2){
        ...
        if (key === 'cookie') {
            if (current != null) {
                headers[key] = Array.isArray(current) ? (current.push(val), current) : [
                    current,
                    val
                ];
            } else {
 ...
 */ class Client extends DispatcherBase {
   ...
   */ constructor(url, { maxHeaderSize, headersTimeout, socketTimeout, requestTimeout, connectTimeout, bodyTimeout, idleTimeout, keepAlive, keepAliveTimeout, maxKeepAliveTimeout, keepAliveMaxTimeout, keepAliveTimeoutThreshold, socketPath, pipelining, tls, strictContentLength, maxCachedSessions, connect, maxRequestsPerClient, localAddress, maxResponseSize, autoSelectFamily, autoSelectFamilyAttemptTimeout, // h2
    maxConcurrentStreams, allowH2, useH2c, initialWindowSize, connectionWindowSize, pingInterval, webSocket, h2Options, eventSource } = {}){
...
const { PoolBase, kClients, kNeedDrain, kAddClient, kGetDispatcher, kHasDispatcher, kRemoveClient } = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/pool-base.js [app-route] (ecmascript)");
const Client = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/client.js [app-route] (ecmascript)");
const { InvalidArgumentError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
...
const Pool = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/pool.js [app-route] (ecmascript)");
const DispatcherBase = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/dispatcher-base.js [app-route] (ecmascript)");
const { InvalidArgumentError, RequestAbortedError, SecureProxyConnectionError, ProxyConnectionError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const buildConnector = __turbopack_context__.r("[project]/node_modules/undici/lib/core/connect.js [app-route] (ecmascript)");
const Client = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/client.js [app-route] (ecmascript)");
const { channels } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/diagnostics.js [app-route] (ecmascript)");
...
const { hasSafeIterator } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
...
;
const DispatcherBase = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/dispatcher-base.js [app-route] (ecmascript)");
const { ConnectTimeoutError, InvalidArgumentError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
...
const { kBusy, kConnected, kDispatch, kClose, kDestroy } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const Pool = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/pool.js [app-route] (ecmascript)");
const buildConnector = __turbopack_context__.r("[project]/node_modules/undici/lib/core/connect.js [app-route] (ecmascript)");
const { setupConnectTimeout } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
...
//# sourceMappingURL=node_modules_undici_lib_dispatcher_0wsv20j._.js.map