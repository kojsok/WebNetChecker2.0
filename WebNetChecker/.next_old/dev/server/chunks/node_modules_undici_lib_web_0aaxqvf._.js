...
const { isValidHeaderValue, kEnumerableProperty } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
...
const { createPotentialCORSRequest } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/eventsource/util.js [app-route] (ecmascript)");
...
const { FormData, setFormDataState, getFormDataBoundary } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/formdata.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
...
const { ReadableStreamTee } = __turbopack_context__.r("[externals]/node:stream/web [external] (node:stream/web, cjs)");
const textEncoder = new TextEncoder();
function noop() {}
    ...
    const methods = {
        ...
        textStream () {
            ...
            if (this_.body == null) {
                ...
                /** @type {ReadableStreamDefaultController<any>} */ let controller;
            ...
            /** @type {ReadableStream} */ const stream = this_.body.stream;
...
const { Request, cloneRequest, getRequestDispatcher, getRequestState, removeRequestAbortListener } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/request.js [app-route] (ecmascript)");
...
const { SocketError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
...
const randomFillSync = runtimeFeatures.has('crypto') ? __turbopack_context__.r("[externals]/node:crypto [external] (node:crypto, cjs)").randomFillSync : null;
...
const { addAbortListener } = __turbopack_context__.r("[externals]/node:events [external] (node:events, cjs)");
const { environmentSettingsObject, readableStreamClose } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
...
class WebSocketStream {
    ...
    /** @type {ReturnType<typeof Promise.withResolvers>} */ #openedPromise;
    // Each WebSocketStream object has an associated closed promise , which is a promise.
    /** @type {ReturnType<typeof Promise.withResolvers>} */ #closedPromise;
